  ...
  if (currentTime - previousTime >= 60000 || responseOn200Request) {
    if (wiFI.wiFiLinkCheck()) {
      ...
      if (wiFI.CheckMQTTConnection()) {
        ...
        // float avgVoltage = powerData.totalVoltge / sampleCount;
        // float avgCurrent = powerData.totalCurrent / sampleCount;
        // float avgPower = powerData.totalPower / sampleCount;
        ...
        if (responseOn200Request) {
          ...
          // wiFI.publishMqttMsg(Topic.Publish, "300", avgVoltage, avgCurrent, avgPower, relayLoadStaus, autoMotionDetect_Flag);
          ...
          //  wiFI.publishMqttMsg(Topic.Publish, deviceId, avgVoltage, avgCurrent, avgPower, relayLoadStaus, autoMotionDetect_Flag);
