...
void myWIFI::publishMqttMsg(String pubTopic, String devID, float voltage, float current, double power, bool loadStatus) {
  String Final = "{device_id:" + devID + ":" + String(voltage) + ":" + String(current) + ":" + String(power) + ":" + String(loadStatus) + "}";
