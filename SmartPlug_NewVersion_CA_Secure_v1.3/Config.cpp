...
byte MAC[6] = { 0x8C, 0x4C, 0xAD, 0xF0, 0xBF, 0x45 };
...
const byte motionDetectThresholdMsgEEPROM = 47;
...
// const char _PIRSensorPin = 16;
// const char _PIRSensorPin = D0;
const char _PIRSensorPin = D6;
...
unsigned int motionCounter = 10;   // Time to keep the load ON after detecting motion (in seconds)
